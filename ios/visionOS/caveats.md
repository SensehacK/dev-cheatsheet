...
You can just isolate this logic with [wildcard checks](wildcard_checks.md#Check%20OS%20Support) specifically to avoid VisionOS.
...
## [Migration to visionOS](migration.md#VisionOS)
